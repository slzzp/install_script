...
# ref: http://www.php.net/get/php-5.5.16.tar.gz/from/a/mirror
URLPHP='http://www.php.net/distributions/php-5.5.16.tar.gz'
...
#  --with-openssl \
# bug ? OpenSSL 1.0.1e has no openssl/evp.h but php-5.5.16 --with-openssl need it
