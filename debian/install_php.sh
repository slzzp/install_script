...
# ref: http://www.php.net/get/php-5.6.5.tar.gz/from/a/mirror
URL_PHP='http://www.php.net/distributions/php-5.6.5.tar.gz'
...
#  --with-openssl \
# bug ? OpenSSL 1.0.1e has no openssl/evp.h but php-5.6.5 --with-openssl need it
